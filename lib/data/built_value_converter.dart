...
class BuiltValueConverter extends JsonConverter {
  ...
  Request convertRequest(Request request) {
    return super.convertRequest(request.replace(
      body: serializers.serializeWith(serializers.serializerForType(request.body.runtimeType), request.body),
    ));
  }
  ...
  BuiltList _deserialize<SingleItemType>(Map<String, dynamic> value,) {
