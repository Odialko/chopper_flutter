...
class BuiltValueConverter extends JsonConverter {
  ...
  dynamic _convertToCustomObject<SingleItemType>(dynamic element) {
    ...
    if(element is List)
      return _desirializeListOf<SingleItemType>(element);
    else return _desirialize<SingleItemType>(element);
  }

  BuiltList<SingleItemType> _desirializeListOf<SingleItemType> (List dynamicList) {
    return BuiltList<SingleItemType>(
      dynamicList.map((element) => _desirialize<SingleItemType>(element),)
    );
  }

  SingleItemType _desirialize<SingleItemType> (Map<String, dynamic> value) {
